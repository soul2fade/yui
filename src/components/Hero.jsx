  ...
  return (
    <section className="bg-ink text-white">
      <div className="mx-auto max-w-6xl px-6 py-24 sm:px-8 sm:py-32">
        ...
        {/* The name story sits inside the hero rather than in its own section
            below the fold, so the word nobody can pronounce is explained on the
            first screen. Full width and two text columns, so it reads as a
            landscape band instead of a tall sidebar. */}
        <div id="name" className="mt-12 scroll-mt-24">
          <NameCard tone="ink" layout="wide" />
        </div>
      </div>
    </section>
  )
